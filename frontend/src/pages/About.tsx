    ...
    <div className="min-h-screen">
      ...
      <section className="section-container">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-sawatsya-sand h-80 rounded-lg flex items-center justify-center">
            <div className="text-center">
              <h3 className="text-2xl font-serif text-sawatsya-earth">Quality & Tradition</h3>
              <p className="text-sawatsya-earth mt-2">Since 2010</p>
            </div>
          </div>
        </div>
      </section>
